    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (questionText.isEmpty() || topicText.isEmpty() || option1Text.isEmpty() ||
                    ...
                    if (checkInsertData) {
                        Toast.makeText(MainActivity.this, "New Question Added", Toast.LENGTH_SHORT).show();
                        clearFields();
                    } else {
                        Toast.makeText(MainActivity.this, "Failed to add the question", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (questionText.isEmpty() || topicText.isEmpty() || option1Text.isEmpty() ||
                    ...
                    if (checkUpdateData) {
                        ...
                        Toast.makeText(MainActivity.this, "Failed to update the question", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (questionText.isEmpty()) {
                    Toast.makeText(MainActivity.this, "Please enter a question to delete", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    builder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            if (checkDeleteData) {
                                ...
                                Toast.makeText(MainActivity.this, "Failed to delete the question", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (res.getCount() == 0) {
                    Toast.makeText(MainActivity.this, "No Questions", Toast.LENGTH_SHORT).show();
                    return;
                }
